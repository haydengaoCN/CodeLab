...
template<> ::tutorial::Config* Arena::CreateMaybeMessage<::tutorial::Config>(Arena*);
...
class Config PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tutorial.Config) */ {
 public:
  ...
  enum : int {
    kNewOrderClassDatypeListFieldNumber = 2,
    kEnableNewClassLogicFieldNumber = 1,
  };
  // repeated string new_order_class_datype_list = 2;
  int new_order_class_datype_list_size() const;
  private:
  int _internal_new_order_class_datype_list_size() const;
  public:
  void clear_new_order_class_datype_list();
  const std::string& new_order_class_datype_list(int index) const;
  std::string* mutable_new_order_class_datype_list(int index);
  void set_new_order_class_datype_list(int index, const std::string& value);
  void set_new_order_class_datype_list(int index, std::string&& value);
  void set_new_order_class_datype_list(int index, const char* value);
  void set_new_order_class_datype_list(int index, const char* value, size_t size);
  std::string* add_new_order_class_datype_list();
  void add_new_order_class_datype_list(const std::string& value);
  void add_new_order_class_datype_list(std::string&& value);
  void add_new_order_class_datype_list(const char* value);
  void add_new_order_class_datype_list(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& new_order_class_datype_list() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_new_order_class_datype_list();
  private:
  const std::string& _internal_new_order_class_datype_list(int index) const;
  std::string* _internal_add_new_order_class_datype_list();
  public:

  // optional bool enable_new_class_logic = 1;
  bool has_enable_new_class_logic() const;
  private:
  bool _internal_has_enable_new_class_logic() const;
  public:
  void clear_enable_new_class_logic();
  bool enable_new_class_logic() const;
  void set_enable_new_class_logic(bool value);
  private:
  bool _internal_enable_new_class_logic() const;
  void _internal_set_enable_new_class_logic(bool value);
  public:

  // @@protoc_insertion_point(class_scope:tutorial.Config)
 private:
  class _Internal;
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> new_order_class_datype_list_;
  bool enable_new_class_logic_;
  friend struct ::TableStruct_addressbook_2eproto;
};
// ===================================================================
...
inline bool Person::_internal_has_last_updated() const {
  ...
  PROTOBUF_ASSUME(!value || last_updated_ != nullptr);
  return value;
}
...
// optional bool enable_new_class_logic = 1;
inline bool Config::_internal_has_enable_new_class_logic() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool Config::has_enable_new_class_logic() const {
  return _internal_has_enable_new_class_logic();
}
inline void Config::clear_enable_new_class_logic() {
  enable_new_class_logic_ = false;
  _has_bits_[0] &= ~0x00000001u;
}
inline bool Config::_internal_enable_new_class_logic() const {
  return enable_new_class_logic_;
}
inline bool Config::enable_new_class_logic() const {
  // @@protoc_insertion_point(field_get:tutorial.Config.enable_new_class_logic)
  return _internal_enable_new_class_logic();
}
inline void Config::_internal_set_enable_new_class_logic(bool value) {
  _has_bits_[0] |= 0x00000001u;
  enable_new_class_logic_ = value;
}
inline void Config::set_enable_new_class_logic(bool value) {
  _internal_set_enable_new_class_logic(value);
  // @@protoc_insertion_point(field_set:tutorial.Config.enable_new_class_logic)
}

// repeated string new_order_class_datype_list = 2;
inline int Config::_internal_new_order_class_datype_list_size() const {
  return new_order_class_datype_list_.size();
}
inline int Config::new_order_class_datype_list_size() const {
  return _internal_new_order_class_datype_list_size();
}
inline void Config::clear_new_order_class_datype_list() {
  new_order_class_datype_list_.Clear();
}
inline std::string* Config::add_new_order_class_datype_list() {
  // @@protoc_insertion_point(field_add_mutable:tutorial.Config.new_order_class_datype_list)
  return _internal_add_new_order_class_datype_list();
}
inline const std::string& Config::_internal_new_order_class_datype_list(int index) const {
  return new_order_class_datype_list_.Get(index);
}
inline const std::string& Config::new_order_class_datype_list(int index) const {
  // @@protoc_insertion_point(field_get:tutorial.Config.new_order_class_datype_list)
  return _internal_new_order_class_datype_list(index);
}
inline std::string* Config::mutable_new_order_class_datype_list(int index) {
  // @@protoc_insertion_point(field_mutable:tutorial.Config.new_order_class_datype_list)
  return new_order_class_datype_list_.Mutable(index);
}
inline void Config::set_new_order_class_datype_list(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:tutorial.Config.new_order_class_datype_list)
  new_order_class_datype_list_.Mutable(index)->assign(value);
}
inline void Config::set_new_order_class_datype_list(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:tutorial.Config.new_order_class_datype_list)
  new_order_class_datype_list_.Mutable(index)->assign(std::move(value));
}
inline void Config::set_new_order_class_datype_list(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  new_order_class_datype_list_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:tutorial.Config.new_order_class_datype_list)
}
inline void Config::set_new_order_class_datype_list(int index, const char* value, size_t size) {
  new_order_class_datype_list_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:tutorial.Config.new_order_class_datype_list)
}
inline std::string* Config::_internal_add_new_order_class_datype_list() {
  return new_order_class_datype_list_.Add();
}
inline void Config::add_new_order_class_datype_list(const std::string& value) {
  new_order_class_datype_list_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:tutorial.Config.new_order_class_datype_list)
}
inline void Config::add_new_order_class_datype_list(std::string&& value) {
  new_order_class_datype_list_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:tutorial.Config.new_order_class_datype_list)
}
inline void Config::add_new_order_class_datype_list(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  new_order_class_datype_list_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:tutorial.Config.new_order_class_datype_list)
}
inline void Config::add_new_order_class_datype_list(const char* value, size_t size) {
  new_order_class_datype_list_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:tutorial.Config.new_order_class_datype_list)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Config::new_order_class_datype_list() const {
  // @@protoc_insertion_point(field_list:tutorial.Config.new_order_class_datype_list)
  return new_order_class_datype_list_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
Config::mutable_new_order_class_datype_list() {
  // @@protoc_insertion_point(field_mutable_list:tutorial.Config.new_order_class_datype_list)
  return &new_order_class_datype_list_;
}
